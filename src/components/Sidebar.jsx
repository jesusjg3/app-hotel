  ...
  return (
    <aside className="sidebar">
      <nav className="sidebar-nav">
        ...
        {/* Inicio para Admin y Propietario */}
        ...
        {/* Habitaciones para Admin y Usuario */}
        ...
        {/* Servicios Extras solo Admin */}
        {rol === "Administrador" && (
          <NavLink to="/dashboard/servicios-extras" className="sidebar-btn">
            <FaCog /> <span>Servicios Extras</span>
          </NavLink>
        )}

        {/* Empleados para Admin y Propietario */}
        {(rol === "Administrador" || rol === "Propietario") && (
